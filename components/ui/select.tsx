...
const selectTriggerVariants = cva(
  "flex gap-0.5 w-full items-center justify-between rounded-md text-sm transition-colors focus-visible:outline-none focus-visible:border-primary focus-visible:ring-[3px] focus-visible:ring-primary/50 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
  {
    variants: {
      variant: {
        default: "border border-input rounded-md bg-secondary/30 px-3 py-2 h-9",
        ghost: "bg-transparent h-9 hover:bg-muted",
